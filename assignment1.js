...
module.exports = class FoodOrder extends Order{
    ...
    handleInput(sInput){
        ...
        switch(this.stateCur){
          ...
          /*case OrderState.NAME:   
              ...
              if((!/[^a-zA-Z]/.test(this.sName)))
                    var regName = /^[a-zA-Z]+$/;
                    if(!regName.test(this.sName))
                    {
                            aReturn.push("Invalid name given.");
                    }else
                    {
                            aReturn.push("Please enter valid name: FirstName");
                            this.stateCur = OrderState.BEGIN;
          ...
          case OrderState.DRINKS:
              ...
              aReturn.push(`${this.sUrl}/payment/${this.sName}/`);  
              break; 
    ...
    renderForm(sTitle = "-1", sAmount = "-1"){
      ...
      <body>
        ...
        Thank you ${this.sName} for your ${this.sItem} order of $${this.nOrder}.
